...
public class ReplacePhoneActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if (!oldPhoneString.equals("")) {
            replacePhoneTv.setText(oldPhoneString);
        }
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.replace_phone_btn: // 确认修改验证码
                ...
                if (code.equals("")) {
                    ...
                    intent1.putExtra("OLD_PHONE", replacePhoneString = replacePhoneEt.getText().toString().trim());
    ...
    class TimeCount extends CountDownTimer {
        ...
        public void onFinish() { // 计时完毕时触发
            ...
            replacePhoneCode.setClickable(true);
            replacePhoneCode.setTextColor(getResources().getColor(R.color.white));
            replacePhoneCode.setBackgroundResource(R.drawable.background_shape);
        }
        ...
        public void onTick(long millisUntilFinished) { // 计时过程显示
            ...
            replacePhoneCode.setTextColor(getResources().getColor(R.color.black));
    ...
    public boolean isRegistMobileNO() {
        ...
        Matcher matcherRegistMobile = patternRegistMobile.matcher(replacePhoneString);
