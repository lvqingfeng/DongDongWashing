...
public class DialogByProgress extends Dialog {
    ...
    public DialogByProgress(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        this.mContext = context;
    }

    public DialogByProgress(Context context, int theme) {
        super(context, theme);
        // TODO Auto-generated constructor stub
        this.mContext = context;
    }

    public DialogByProgress(Context context, boolean cancelable, OnCancelListener cancelListener) {
