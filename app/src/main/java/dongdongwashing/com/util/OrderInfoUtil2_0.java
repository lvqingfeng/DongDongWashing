...
public class OrderInfoUtil2_0 {
     ...
     * @return
     */
    public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2, String orderTotalStr, String orderNumber, String createOrderTimeStr) {
        Map<String, String> keyValues = new HashMap<String, String>();
        ...
        keyValues.put("timestamp", createOrderTimeStr);
